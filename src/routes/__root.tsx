...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Job Match Pro analyzes your CV against job descriptions to provide actionable application feedback." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Job Match Pro analyzes your CV against job descriptions to provide actionable application feedback." },
